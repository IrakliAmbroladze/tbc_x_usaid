...
const Post = ({ post }: PostProps): JSX.Element => {
  ...
  return (
    <div
      key={post.id}
      className="w-full max-w-[1110px] mx-auto p-6 bg-white shadow-lg rounded-lg my-6 border border-gray-200 hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out"
    >
